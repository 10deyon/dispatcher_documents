<div class="app-header header-shadow">
    <div class="app-header__logo">
        <div class="logo1-src">DISPATCHER</div>
                    ...
                    <div class="widget-content-wrapper">
                            ...
                            <div class="btn-group">
                                ...
                                <div tabindex="-1" role="menu" aria-hidden="true" class="rm-pointers dropdown-menu-lg dropdown-menu dropdown-menu-right">
                                            ...
                                            <div class="menu-header-content text-left">
                                                <div class="widget-content p-0">
                                                    <div class="widget-content-wrapper">
                                                        ...
                                                        <div class="widget-content-left">
                                                            <div class="widget-heading"><?php echo idToProfile($userId); ?>
                                                            </div>
                                                        </div>
                                                        <div class="widget-content-right mr-2">
                                                            <form method="post">
                                                                <button name="logoutUser" class="btn-pill btn-shadow btn-shine btn btn-focus">Logout
                                                            </form>
                                    ...
                                    <div class="scroll-area-xs" style="height: 150px;">
                                        <div class="scrollbar-container ps">
                                            <ul class="nav flex-column">
                                                ...
                                                <li class="nav-item">
                                                    <a href="profile.php" class="nav-link">View Profile
                                                    </a>
                                                </li>
                                    ...
                                    <ul class="nav flex-column">
                                        <li class="nav-item-btn text-center nav-item">
                                            <form method="post">
                                                <button name="logoutUser" class="btn-wide btn btn-primary btn-sm">Logout
                                            </form>
                                        </li>
                                    </ul>
                                </div>
                        ...
                        <div class="widget-content-left  ml-3 header-user-info">
                            <div class="widget-heading">
                                <?php echo idToProfile($userId); ?>
                            </div>
                            <div class="widget-subheading">
                                <?php echo idToProfile($userId,'position'); ?>
                            </div>
                        </div>
